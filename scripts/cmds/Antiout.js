module.exports = {
  ...
  onStart: async function({ message, event, threadsData, args }) {
    ...
    return message.reply(`𝐢𝐳𝐚𝐧𝐚𝐦𝐢 𝐚𝐜𝐭𝐢𝐯𝐞𝐫 𝐯𝐨𝐮𝐬 𝐧𝐞 𝐩𝐨𝐮𝐯𝐞𝐳 𝐩𝐥𝐮𝐬 𝐫𝐢𝐞𝐧 𝐜𝐨𝐧𝐭𝐫𝐞 𝐦𝐨𝐧 𝐦𝐚𝐢̂𝐭𝐫𝐞 🔄⌚😈 ${args[0] === "on" ? "𝐕𝐨𝐮𝐬 𝐞𝐭𝐞𝐬 𝐭𝐨𝐮𝐬 𝐩𝐢𝐞𝐠𝐞𝐬👻" : "𝐚𝐫𝐡!!  𝐥'𝐢𝐳𝐚𝐧𝐚𝐦𝐢 𝐚𝐬 𝐞́𝐭𝐚𝐢𝐭 𝐫𝐨𝐦𝐩𝐮 𝐭𝐮 𝐝𝐞𝐯𝐢𝐞𝐧𝐬 𝐯𝐮𝐥𝐧𝐞́𝐫𝐚𝐛𝐥𝐞𝐬...𝐩𝐚𝐮𝐯𝐫𝐞 𝐜𝐨𝐧 🤡"}.`);
  },
